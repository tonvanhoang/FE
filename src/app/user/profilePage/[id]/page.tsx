...
import PrivateIndividual from "../../privatePage/page";
interface User {
  _id: string;
  email: string;
  firstName: string;
...
export default function Profile({ params }: { params: { id: string } }) {
  ...
  function hienPosts() {
    ...
    let priv = document.getElementById('containerPrivate') as HTMLElement;
    if (post && reel) {
      ...
      <main>
        ...
        <div className="tabs">
          ...
          </div>
          {
            loggedInUser._id === params.id && (
              <div className="tab">
              <i className="fa-solid fa-grid p-1" onClick={hienPrivate}>Riêng tư</i>
            </div>
            )
          }
        </div>
        ...
        <PrivateIndividual params={params} />
